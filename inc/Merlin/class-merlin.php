...
class Merlin
{
	...
	function __construct($config = array(), $strings = array())
	{
		...
		add_action('init', array($this, 'streamit_download_file'));
	}
	...
	protected function welcome()
	{
		...
		$php_configs = array(
			'max_execution_time' => array('require' => 1000, 'current' => ini_get('max_execution_time')),
		...
		<div class="merlin__content--transition">
			...
			<div class="content-right">
				<div class="content-right-inner">
					...
					<p>
						<strong><?php esc_html_e("About child theme", "streamit"); ?></strong><br>
						<?php
						esc_html_e("A child theme allows you to change small aspects of your site's appearance yet still preserve your theme's look and functionality. To understand how child themes work it is first important to understand the relationship between parent and child themes.", "streamit");
						?>
...
<?php
	...
	public function streamit_download_file()
	{
		if (isset($_GET["download_item"]) && !empty($_GET['download_item']) && is_user_logged_in()) {
			$this->streamit_send_download_file($_GET['download_item']);
		}
	}
	public	function streamit_send_download_file($remoteURL)
	{
