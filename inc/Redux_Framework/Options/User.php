	...
	protected function set_widget_option()
	{
		...
		Redux::set_section($this->opt_name, array(
			...
			'fields' => array(
				...
				array(
					'id'    => 'steamit_view_all_info',
					'type'  => 'info',
					'title' => esc_html__('Note:', 'streamit'),
					'style' => 'info',
					'desc'  => esc_html__('Selected Page Require ShortCode For Filtered Content : [iqonic_view_all]', 'streamit')
				),
