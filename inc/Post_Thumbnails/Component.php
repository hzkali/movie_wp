<?php
/**
 * Streamit\Utility\Post_Thumbnails\Component class
 *
 * @package streamit
 */

namespace Streamit\Utility\Post_Thumbnails;
...
class Component implements Component_Interface {
	...
	public function action_add_image_sizes() {
		add_image_size('streamit-featured-image', 2000, 1200, true);
		add_image_size('streamit-thumbnail-avatar', 100, 100, true);
	}
}
