	...
	<form id="add_payment_method" method="post">
		<div id="payment" class="woocommerce-Payment">
			...
			<div class="form-row p-0 mb-0">
				...
				<button type="submit" class="woocommerce-Button woocommerce-Button--alt  alt iq-button btn btn-hover" id="place_order" value="<?php esc_attr_e( 'Add payment method', 'streamit' ); ?>">
...
<?php else : ?>
	<p class="woocommerce-notice woocommerce-notice--info woocommerce-info"><?php esc_html_e( 'New payment methods can only be added during checkout. Please contact us if you require assistance.', 'streamit' ); ?></p>
<?php endif; ?>
